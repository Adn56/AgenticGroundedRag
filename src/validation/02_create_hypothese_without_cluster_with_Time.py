...
TEMPERATURE = 0 # ursprünglich: 0.4
...
OUT_HYP_JSONL = OUT_DIR / f"hypotheses_{SEED_TAG}_without_cluster_withTime.jsonl"
OUT_PROMPT_CSV = OUT_DIR / f"prompts_{SEED_TAG}_without_cluster_withTime.csv"
OUT_USAGE_CSV = OUT_DIR / f"usage_{SEED_TAG}_without_cluster_withTime.csv"
...
def format_datetime(date_ymd: str, date_day: str, date_time: str) -> str:
