...
DATASET_DIR  = PROJECT_ROOT / "prompt_ablation"

JSONL_INPUT = (
        DATASET_DIR / "hypothesis_test_eval_1000_withTime.jsonl"
)

CSV_OUTPUT = (
        DATASET_DIR / "hypothesis_test_eval_1000_withTime_embeddings.csv"
)
